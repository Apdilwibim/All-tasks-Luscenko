...
document.querySelector('.three').innerHTML = '<h3>Hello again</h3>';
...
document.querySelector('.four').innerHTML = '<h4>What are you doing?</h4>';
document.querySelector('.four').innerHTML += '<p>Lorem ipsum dolor sit</p>';
...
document.querySelector('.mul').innerHTML = z1 * z2;
...
document.querySelector('.diff').innerHTML = y1 / y2;
...
console.log(d1); //вывод тега со всем содержимым
