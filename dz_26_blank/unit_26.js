...
function t4() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num1=6&num2=23')
    .then(data => data.text())
    .then(data => {
...
function t6() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=2&num2=54')
    .then(data => data.text())
    .then(data => {
...
function t11() {
    ...
    redirect: 'follow', // manual, *follow, error
    referrerPolicy: 'no-referrer', // no-referrer, *client
    body: 'auth=5ADcB96BA48d3f80&action=2&name=Pavel' // body data type must match "Content-Type" header
})
    .then(response => response.text())
    .then(response => {
...
function t12() {
    ...
    redirect: 'follow', // manual, *follow, error
    referrerPolicy: 'no-referrer', // no-referrer, *client
    body: 'auth=5ADcB96BA48d3f80&action=3&num1=6&num2=3' // body data type must match "Content-Type" header
})
    .then(response => response.text())
    .then(response => {
...
function t13() {
    ...
    redirect: 'follow', // manual, *follow, error
    referrerPolicy: 'no-referrer', // no-referrer, *client
    body: 'auth=5ADcB96BA48d3f80&action=4&num1=64&num2=23' // body data type must match "Content-Type" header
})
    .then(response => response.text())
    .then(response => {
...
function t15() {
    ...
    redirect: 'follow', // manual, *follow, error
    referrerPolicy: 'no-referrer', // no-referrer, *client
    body: 'auth=5ADcB96BA48d3f80&action=6&num1=34&num2=33' // body data type must match "Content-Type" header
})
    .then(response => response.text())
    .then(response => {
...
function t17() {
    ...
    redirect: 'follow', // manual, *follow, error
    referrerPolicy: 'no-referrer', // no-referrer, *client
    body: 'auth=5ADcB96BA48d3f80&action=8&year=1998' // body data type must match "Content-Type" header
})
    .then(response => response.text())
    .then(response => {
