...
function t2() {
    ...
    xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=2&name=Pavel", true);
    xhttp.send();
    function myFunction(data) {
...
function t3() {
    ...
    xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=3&num1=2&num2=10", true);
    xhttp.send();
    function myFunction(data) {
...
function t4() {
    ...
    xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num1=0&num2=10", true);
    xhttp.send();
    function myFunction(data) {
...
function t6() {
    ...
    xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=5&num2=15", true);
    xhttp.send();
    function myFunction(data) {
...
function t8() {
    ...
    xhttp.open('GET', "http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=8&year=1998", true)
    xhttp.send();
    function myFunction(data) {
...
function t10() {
    ...
    xhttp.open('POST', "http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=1", true);
...
function t11() {
    ...
    xhttp.open('POST', "http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=2&name=Pavel", true);
    xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    xhttp.send('auth=5ADcB96BA48d3f80&action=2');
...
function t12() {
    ...
    xhttp.open('POST', "http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=3&num1=2&num2=1", true);
    xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    xhttp.send('auth=5ADcB96BA48d3f80&action=3');
...
function t13() {
    ...
    xhttp.open('POST', "http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num1=1&num2=100", true);
    xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    xhttp.send('auth=5ADcB96BA48d3f80&action=4');
...
function t14() {
    ...
    xhttp.open('POST', "http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=5", true);
    xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
...
function t15() {
    ...
    xhttp.open('POST', "http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=4&num2=8", true);
    xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    xhttp.send('auth=5ADcB96BA48d3f80&action=6');
...
function t16() {
    ...
    xhttp.open('POST', "http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=7", true);
    xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
...
function t17() {
    ...
    xhttp.open('POST', "http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=8&year=1998", true);
    xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    xhttp.send('auth=5ADcB96BA48d3f80&action=8');
...
function t18() {
    ...
    xhttp.open('POST', "http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=9&m=1&d=1&y=1", true);
    xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    xhttp.send('auth=5ADcB96BA48d3f80&action=9');
